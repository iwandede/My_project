...
class DRiwayatPendidikanNonFormal extends Doctrine_Record {

    public function setTableDefinition() {
        $this->hasColumn("pegawai_id", "integer", 4);
        $this->hasColumn("jenis_kursus", "string", 128, array("notnull" => false));
    ...
    public function setUp() {
        $this->setTableName("klh_riwayatpendidikannonformal");
