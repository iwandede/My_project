<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Berita</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open_multipart("berita/edit_process"); ?>
        <?php echo form_hidden("id",$berita->id); ?>
        <table class="form">
            <tbody id="berita" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="judul">Judul berita</label></td>
                    <td><?php echo form_input("judul", $berita->judul); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="userfile">Ganti foto</label></td>
                    <td><?php echo form_upload("userfile"); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="isi">Isi berita</label></td>
                    <td><?php echo form_textarea("isi", $berita->isi); ?></td>
                </tr>
            </tbody>
