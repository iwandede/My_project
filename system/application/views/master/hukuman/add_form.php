<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Tambah Jenis Hukuman Disiplin</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/hukuman/add_process"); ?>
        <table class="form">
            <tbody id="hukuman" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="jenis_hukuman">Jenis hukuman</label></td>
                    <td><?php echo form_input("jenis_hukuman", "", "class=\"large\""); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="tingkat">Tingkat hukuman</label></td>
                    <td><?php echo form_dropdown("tingkat", $opt_hukuman_disiplin_tingkat); ?></td>
                </tr>
            </tbody>
