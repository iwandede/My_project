<div id="main_content">
    <ul>
        <li><a href="#tabs-1">Daftar Jenis Diklat</a></li>
        <li><a href="<?php echo site_url("master/diklat/add"); ?>">Tambah Jenis Diklat</a></li>
    </ul>
    <div id="tabs-1">
            ...
            <tbody>
                ...
                foreach ($diklats as $diklat) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo anchor("master/diklat/edit/$diklat->id", "<img src='" . site_url("img/b_edit.png") . "' alt='Ubah' title='Ubah' />"); ?>
                            <?php echo anchor("master/diklat/delete_process/$diklat->id", "<img src='" . site_url("img/b_drop.png") . "' alt='Hapus' title='Hapus' />"); ?>
                        </td>
                    </tr>
                    <?php
                    $i++;
