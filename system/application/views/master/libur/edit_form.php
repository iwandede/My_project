<?php
$waktu = array("", "", "", "");
$waktu[$libur->periodik] = $libur->waktu;
?>
<div id="main_content">
    <ul>
        <li><a href="<?php echo site_url("master/libur/manage"); ?>">Daftar Hari Libur</a></li>
        <li><a href="#tabs-1">Ubah Hari Libur</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/libur/edit_process"); ?>
        <?php echo form_hidden("id", $libur->id); ?>
        <table class="form">
            <tbody id="hari_libur" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="periodik">Periode</label></td>
                    <td><?php echo form_dropdown("periodik", $periodik, $libur->periodik); ?></td>
                </tr>
                <tr>
                    <td><label for="waktu1">Waktu</label></td>
                    <td><?php echo form_input("waktu1", $waktu[0]); ?></td>
                </tr>
                <tr>
                    <td><label for="waktu2">Waktu</label></td>
                    <td><?php echo form_dropdown("waktu2", $minggu, $waktu[1]); ?></td>
                </tr>
                <tr>
                    <td><label for="waktu3">Waktu</label></td>
                    <td><?php echo form_input("waktu3", $waktu[2]); ?></td>
                </tr>
                <tr>
                    <td><label for="waktu4">Waktu</label></td>
                    <td><?php echo form_input("waktu4", $waktu[3]); ?></td>
                </tr>
                <tr>
                    <td><label for="keterangan">Keterangan</label></td>
                    <td><input id="keterangan" name="keterangan" type="text" length="64" value="<?php echo $libur->keterangan; ?>" /></td>
                </tr>
            </tbody>
