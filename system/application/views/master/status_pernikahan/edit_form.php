<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Status Pernikahan</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/statuspernikahan/edit_process"); ?>
        <?php echo form_hidden("id", $statuspernikahan->id); ?>
        <table class="form">
            <tbody id="statuspernikahan" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="status_pernikahan">Status pernikahan</label></td>
                    <td><?php echo form_input("status_pernikahan", $statuspernikahan->status_pernikahan); ?></td>
                </tr>
            </tbody>
