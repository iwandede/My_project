...
<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Jabatan</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/jabatan/edit_process"); ?>
        <?php echo form_hidden("id", $jabatan->id); ?>
        <table class="form">
            <tbody id="jabatan" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="nama_eselon">Nama jabatan</label></td>
                    <td><?php echo form_textarea("nama_eselon", $jabatan->nama_eselon); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="minimal_pangkat">Minimal pangkat</label></td>
                    <td><?php echo form_dropdown("minimal_pangkat", $opt_pangkat, $jabatan->minimal_pangkat); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="eselon">Eselon</label></td>
                    <td><?php echo form_dropdown("eselon", $opt_eselon, $jabatan->eselon); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="urutan_duk">Urutan DUK</label></td>
                    <td><?php echo form_input("urutan_duk", $jabatan->urutan_duk); ?></td>
                </tr>
            </tbody>
