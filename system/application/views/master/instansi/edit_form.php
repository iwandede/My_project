<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Instansi</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/instansi/edit_process"); ?>
        <?php echo form_hidden("id", $instansi->id); ?>
        <table class="form">
            <tbody id="instansi" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="nama_instansi">Nama instansi</label></td>
                    <td><?php echo form_input("nama_instansi", $instansi->nama_instansi); ?></td>
                </tr>
            </tbody>
