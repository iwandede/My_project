<div id="main_content">
    <ul>
        <li><a href="#tabs-1">Daftar Instansi</a></li>
        <li><a href="<?php echo site_url("master/instansi/add"); ?>">Tambah Instansi</a></li>
    </ul>
    <div id="tabs-1">
            ...
            <tbody>
                ...
                foreach ($instansis as $instansi) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo anchor("master/instansi/edit/$instansi->id", "<img src='" . site_url("img/b_edit.png") . "' alt='Ubah' title='Ubah' />"); ?>
                            <?php echo anchor("master/instansi/delete_process/$instansi->id", "<img src='" . site_url("img/b_drop.png") . "' alt='Hapus' title='Hapus' />"); ?>
                        </td>
                    </tr>
                    <?php
                    $i++;
