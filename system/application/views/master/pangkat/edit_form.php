<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Pangkat</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/pangkat/edit_process"); ?>
        <?php echo form_hidden("id", $pangkat->id); ?>
        <table class="form">
            <tbody id="pangkat" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="nama_pangkat">Nama pangkat</label></td>
                    <td><?php echo form_input("nama_pangkat", $pangkat->nama_pangkat); ?></td>
                </tr>
                <tr>
                    <td><label for="golongan_ruang">Golongan/ruang</label></td>
                    <td><?php echo form_input("golongan_ruang", $pangkat->golongan_ruang); ?></td>
                </tr>
            </tbody>
