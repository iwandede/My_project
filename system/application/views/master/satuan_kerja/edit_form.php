<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Unit Kerja</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/satuankerja/edit_process"); ?>
        <?php echo form_hidden("id", $satuankerja->id); ?>
        <table class="form">
            <tbody id="satuankerja" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="kode_bidang">Kode bidang</label></td>
                    <td><?php echo form_input("kode_bidang", $satuankerja->kode_bidang); ?></td>
                </tr>
                <tr>
                    <td><label for="kode_unit">Kode unit</label></td>
                    <td><?php echo form_input("kode_unit", $satuankerja->kode_unit); ?></td>
                </tr>
                <tr>
                    <td><label for="nama_unit_kerja">Nama unit kerja</label></td>
                    <td><?php echo form_textarea("nama_unit_kerja", $satuankerja->nama_unit_kerja); ?></td>
                </tr>
            </tbody>
