<div id="main_content">
    <ul>
        <li><a href="#tabs-1">Daftar Jenis Cuti</a></li>
        <li><a href="<?php echo site_url("master/cuti/add"); ?>">Tambah Jenis Cuti</a></li>
    </ul>
    <div id="tabs-1">
            ...
            <tbody>
                ...
                foreach ($cutis as $cuti) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo anchor("master/cuti/edit/$cuti->id", "<img src='" . site_url("img/b_edit.png") . "' alt='Ubah' title='Ubah' />"); ?>
                            <?php echo anchor("master/cuti/delete_process/$cuti->id", "<img src='" . site_url("img/b_drop.png") . "' alt='Hapus' title='Hapus' />"); ?>
                        </td>
                    </tr>
                    <?php
                    $i++;
