<div id="main_content">
    <ul>
        <li><a href="#tabs-1">Daftar Agama</a></li>
        <li><a href="<?php echo site_url("master/agama/add"); ?>">Tambah Agama</a></li>
    </ul>
    <div id="tabs-1">
            ...
            <tbody>
                ...
                foreach ($agamas as $agama) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo anchor("master/agama/edit/$agama->id", "<img src='" . site_url("img/b_edit.png") . "' alt='Ubah' title='Ubah' />"); ?>
                            <?php echo anchor("master/agama/delete_process/$agama->id", "<img src='" . site_url("img/b_drop.png") . "' alt='Hapus' title='Hapus' />"); ?>
                        </td>
                    </tr>
                    <?php
                    $i++;
