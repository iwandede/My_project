<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Jenis Surat Keputusan</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("master/suratkeputusan/edit_process"); ?>
        <?php echo form_hidden("id", $suratkeputusan->id); ?>
        <table class="form">
            <tbody id="surat_keputusan" class="fieldset">
                <tr>
                    <td style="width: 200px;"><label for="jenis_sk">Jenis surat keputusan</label></td>
                    <td><?php echo form_input("jenis_sk", $suratkeputusan->jenis_sk); ?></td>
                </tr>
            </tbody>
