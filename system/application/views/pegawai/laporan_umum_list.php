...
$judul_laporan = $args["judul_laporan"] ? $args["judul_laporan"] : "";
...
<div id="main_content">
    <ul>
        ...
        <li><a href="<?php echo site_url("pegawai/laporan/excel/" . $judul_laporan . "/" . $args["status_kerja"] . "/". $args["golongan"] . "/" . $args["eselon"] . "/" . $args["unit_kerja"] . "/" . $args["jenis_kelamin"]); ?>">Download</a></li>
    </ul>
    <div id="tabs-1">
        <div class="info ui-corner-all <?php echo $msg["type"]; ?>">
            <?php echo $msg["content"]; ?>
        </div>
        <?php echo form_open("pegawai/laporan"); ?>
...
<script type="text/javascript">
    $(function() {
        ...
        $("#list_user").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo site_url("pegawai/laporanduk_data/" . $args["status_kerja"] . "/" . $args["golongan"] . "/" . $args["eselon"] . "/" . $args["unit_kerja"] . "/" . $args["jenis_kelamin"]); ?>",
            "oLanguage": {
                "sSearch": "Cari:",
