<div id="main_content">
    <ul>
        ...
        <li><a href="#tabs-1">Ubah Data Organisasi <?php echo $pegawai->nama; ?></a></li>
    </ul>
    <div id="tabs-1">
        ...
        <?php echo form_hidden("modul", "organisasi"); ?>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="data">
            ...
            <tbody>
                <?php
                $i = 1;
                foreach ($pegawai->DROs as $dro) {
                    ?>
                    <tr>
                        <td><?php echo $i . form_hidden("dro_id[]", $dro->id); ?></td>
                        <td><input type="text" name="jenis_organisasi[]" class="large" value="<?php echo $dro->jenis_organisasi; ?>" /></td>
                        <td><input type="text" name="tanggal_mulai[]" class="date" value="<?php echo enformat_date($dro->tanggal_mulai); ?>" /></td>
                        <td><input type="text" name="tanggal_selesai[]" class="date" value="<?php echo enformat_date($dro->tanggal_selesai); ?>" /></td>
                        <td><input type="text" name="keterangan[]" class="large" value="<?php echo $dro->keterangan; ?>" /></td>
                        <td><a href="<?php echo site_url("pegawai/delete_process/$dro->id/organisasi" . uri_string()); ?>"><img src="<?php echo site_url("img/b_drop.png"); ?>" alt="Hapus" title="Hapus" /></a></td>
                    </tr>
                    <?php
                    $i++;
                }
                ...
                if ($i == 1) {
                    ?>
                    <tr>
                        <td><?php echo $i . form_hidden("dro_id[]", 0); ?></td>
                        <td><input type="text" name="jenis_organisasi[]" class="large" value="" /></td>
            ...
            <tbody class="fieldset">                
                <tr class="button">
                    <td style="text-align: right;">
                        <a href="javascript:addOrganisasi()">Tambah Data Organisasi</a>
...
<script type="text/javascript">
    ...
    var n = next_i - 1;
    var addOrganisasi = function() {
        $("table.data").dataTable().fnAddData( [
            next_i + "<input type=\"hidden\" name=\"dro_id[]\" value=\"0\" />",
            "<input type=\"text\" name=\"jenis_organisasi[]\" class=\"large\" value=\"\" />",
