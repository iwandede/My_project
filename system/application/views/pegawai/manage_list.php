<div id="main_content">
    <ul>
        <li><a href="#tabs-1">Daftar Pegawai</a></li>
            ...
            <tbody>
                ...
                foreach ($pegawais as $pegawai) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo anchor("pegawai/detail/$pegawai->id", "<img src='" . site_url("img/b_browse.png") . "' alt='Lihat' title='Lihat' />"); ?>
                            <?php echo anchor("pegawai/edit/$pegawai->id", "<img src='" . site_url("img/b_edit.png") . "' alt='Ubah' title='Ubah' />"); ?>
                            <?php echo anchor("pegawai/delete_process/$pegawai->id", "<img src='" . site_url("img/b_drop.png") . "' alt='Hapus' title='Hapus' />"); ?>
                        </td>
                    </tr>
                    <?php
                    $i++;
